...
introduces another on a different line, this can manifest as
a keep (\keepsym{}) rather than one add (\addsym{)} and one drop (\dropsym{}).
...
(e.g.,~\cite{pgnwk-koli-2022,wk-icer-2019,hl-icse-2010,j-ieeesoft-2013,kje-ase-2010, mmlb-swvis-2014, ncvjd-ecoop-2013, rl-icse-2008, we-xp-2004}).
...
The Blackbox project collects Java programs and has enabled
dozens of contributions to the area of CS education~\cite{bask-icer-2018,bkmu-sigcse-2014}.
Other logging-based studies of Java programs draw conclusions from compiler error
messages~\cite{bgimgm-cse-2016,dlc-iticse-2014}.
The GRUMPS telemetry system collected 4.7 million keystroke-level actions from
Ada learners~\cite{tkdmceg-ascilite-2003,tm-iticse-2004}.
...
only provides coarse-grained information that would be insufficient in our
study.
