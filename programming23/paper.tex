...
\begin{itemize}
  ...
  \item
    ...
    \emph{TODO We intend to submit these in an artifact.}
...
\begin{enumerate}
  \item
    \uid{}: a \panon{} identifier (16-digit random number) for the current session.
  \item
...
For instance, it does not distinguish edits that ignore a type
...
and the complete lack of private information.
...
from many different sessions and is not dominated by a few high-traffic sessions.
...
\begin{itemize}
  ...
  \item
    When a color appears above the x axis, the same color usually appears below it as well.
    For example, \mnocheck{} has a cluster of purple points near the 20 second mark
    and $\pm 30$ density, which suggests that one session repeatedly added and removed errors.
    The next subsection conducts a thorough analysis.
...
% TE
%   nocheck & 961 & (\pct{38.50}) & 694 & [\pct{27.80}] & 841 & [\pct{33.69}] \\
% FS
%   nocheck & 156422 & (\pct{37.19}) & 153965 & [\pct{36.61}] & 110194 & [\pct{26.20}] \\
% TE mod
%   nocheck & 0 & (\pct{na}) & 0 & [\pct{na}] & 0 & [\pct{na}] \\
% FS mod
%   nocheck & 153913 & (\pct{36.96}) & 152735 & [\pct{36.68}] & 109807 & [\pct{26.37}] \\
% TE
%   nonstrict & 8623 & (\pct{37.67}) & 5263 & [\pct{22.99}] & 9004 & [\pct{39.34}] \\
% FS
%   nonstrict & 18927 & (\pct{37.41}) & 17791 & [\pct{35.17}] & 13872 & [\pct{27.42}] \\
% TE mod
%   nonstrict & 7185 & (\pct{36.61}) & 4768 & [\pct{24.30}] & 7672 & [\pct{39.09}] \\
% FS mod
%   nonstrict & 18573 & (\pct{37.09}) & 17604 & [\pct{35.15}] & 13905 & [\pct{27.76}] \\
% TE
%   strict & 442 & (\pct{38.27}) & 244 & [\pct{21.13}] & 469 & [\pct{40.61}] \\
% FS
%   strict & 296 & (\pct{31.66}) & 360 & [\pct{38.50}] & 279 & [\pct{29.84}] \\
% TE mod
%   strict & 251 & (\pct{35.35}) & 204 & [\pct{28.73}] & 255 & [\pct{35.92}] \\
% FS mod
%   strict & 272 & (\pct{32.04}) & 317 & [\pct{37.34}] & 260 & [\pct{30.62}] \\
...
(e.g.,~\cite{hl-icse-2010,j-ieeesoft-2013,kje-ase-2010, mmlb-swvis-2014, ncvjd-ecoop-2013, rl-icse-2008, we-xp-2004}).
...
Examplar logs programs to give students feedback on their tests~\cite{pgnwk-koli-2022,wk-icer-2019}.
