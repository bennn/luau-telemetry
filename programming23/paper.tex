...
Clients can depend on strong privacy guarantees even if other clients and some
...
though it is unclear what data from type analysis would support meaningful
aggregates.
