...
% 51,761 &              &
  \begin{tabular}[t]{lrrrrl}
    ~          & Mean  & Stddev & Median & \pct{99} Pct. & Distribution \\
...
\begin{figure}[t]\centering
  ...
  \caption{Changes in type error density (errors-in-module / lines-in-module) over time.}
...
regardless of mode.
No matter whether a session is using \mnocheck{}, \mnonstrict{},
...
\begin{itemize}
  \item
    ...
    Sessions tend to fix errors highlighted by type analysis
...
With over 1.5 million telemetry records from over 340,000 sessions
...
At the same time, the data is limited to avoid leaking personal
